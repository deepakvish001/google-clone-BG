...
Define the focus management standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The focus management requirement is explicit and observable.
...
Keep implementation work focused on one focus management outcome and avoid copying third-party branding or behavior without review.