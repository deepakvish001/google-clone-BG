...
Define the color contrast standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The color contrast requirement is explicit and observable.
...
Keep implementation work focused on one color contrast outcome and avoid copying third-party branding or behavior without review.