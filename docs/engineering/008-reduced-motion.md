...
Define the reduced motion standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The reduced motion requirement is explicit and observable.
...
Keep implementation work focused on one reduced motion outcome and avoid copying third-party branding or behavior without review.