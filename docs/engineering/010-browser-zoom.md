...
Define the browser zoom standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The browser zoom requirement is explicit and observable.
...
Keep implementation work focused on one browser zoom outcome and avoid copying third-party branding or behavior without review.