...
Define the touch targets standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The touch targets requirement is explicit and observable.
...
Keep implementation work focused on one touch targets outcome and avoid copying third-party branding or behavior without review.