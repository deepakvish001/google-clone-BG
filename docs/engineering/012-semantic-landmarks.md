...
Define the semantic landmarks standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The semantic landmarks requirement is explicit and observable.
...
Keep implementation work focused on one semantic landmarks outcome and avoid copying third-party branding or behavior without review.