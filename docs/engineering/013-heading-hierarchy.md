...
Define the heading hierarchy standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The heading hierarchy requirement is explicit and observable.
...
Keep implementation work focused on one heading hierarchy outcome and avoid copying third-party branding or behavior without review.