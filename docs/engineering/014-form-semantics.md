...
Define the form semantics standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The form semantics requirement is explicit and observable.
...
Keep implementation work focused on one form semantics outcome and avoid copying third-party branding or behavior without review.