...
Define the document language standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The document language requirement is explicit and observable.
...
Keep implementation work focused on one document language outcome and avoid copying third-party branding or behavior without review.