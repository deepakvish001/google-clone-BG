...
Define the skip link standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The skip link requirement is explicit and observable.
...
Keep implementation work focused on one skip link outcome and avoid copying third-party branding or behavior without review.