...
Define the search form standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The search form requirement is explicit and observable.
...
Keep implementation work focused on one search form outcome and avoid copying third-party branding or behavior without review.