...
Define the query submission standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The query submission requirement is explicit and observable.
...
Keep implementation work focused on one query submission outcome and avoid copying third-party branding or behavior without review.