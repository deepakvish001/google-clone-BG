...
Define the search providers standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The search providers requirement is explicit and observable.
...
Keep implementation work focused on one search providers outcome and avoid copying third-party branding or behavior without review.