...
Define the recent searches standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The recent searches requirement is explicit and observable.
...
Keep implementation work focused on one recent searches outcome and avoid copying third-party branding or behavior without review.