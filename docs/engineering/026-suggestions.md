...
Define the suggestions standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The suggestions requirement is explicit and observable.
...
Keep implementation work focused on one suggestions outcome and avoid copying third-party branding or behavior without review.