...
Define the autocomplete standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The autocomplete requirement is explicit and observable.
...
Keep implementation work focused on one autocomplete outcome and avoid copying third-party branding or behavior without review.