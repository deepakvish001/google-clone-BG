...
Define the keyboard shortcuts standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The keyboard shortcuts requirement is explicit and observable.
...
Keep implementation work focused on one keyboard shortcuts outcome and avoid copying third-party branding or behavior without review.