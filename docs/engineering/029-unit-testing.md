...
Define the unit testing standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The unit testing requirement is explicit and observable.
...
Keep implementation work focused on one unit testing outcome and avoid copying third-party branding or behavior without review.