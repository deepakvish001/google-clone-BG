...
Define the visual regression standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The visual regression requirement is explicit and observable.
...
Keep implementation work focused on one visual regression outcome and avoid copying third-party branding or behavior without review.