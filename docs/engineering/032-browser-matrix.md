...
Define the browser matrix standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The browser matrix requirement is explicit and observable.
...
Keep implementation work focused on one browser matrix outcome and avoid copying third-party branding or behavior without review.