...
Define the mobile testing standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The mobile testing requirement is explicit and observable.
...
Keep implementation work focused on one mobile testing outcome and avoid copying third-party branding or behavior without review.