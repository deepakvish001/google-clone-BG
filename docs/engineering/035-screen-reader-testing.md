...
Define the screen reader testing standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The screen reader testing requirement is explicit and observable.
...
Keep implementation work focused on one screen reader testing outcome and avoid copying third-party branding or behavior without review.