...
Define the edge cases standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The edge cases requirement is explicit and observable.
...
Keep implementation work focused on one edge cases outcome and avoid copying third-party branding or behavior without review.