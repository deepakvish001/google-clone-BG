...
Define the test fixtures standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The test fixtures requirement is explicit and observable.
...
Keep implementation work focused on one test fixtures outcome and avoid copying third-party branding or behavior without review.