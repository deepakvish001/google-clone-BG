...
Define the security baseline standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The security baseline requirement is explicit and observable.
...
Keep implementation work focused on one security baseline outcome and avoid copying third-party branding or behavior without review.