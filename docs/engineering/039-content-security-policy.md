...
Define the content security policy standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The content security policy requirement is explicit and observable.
...
Keep implementation work focused on one content security policy outcome and avoid copying third-party branding or behavior without review.