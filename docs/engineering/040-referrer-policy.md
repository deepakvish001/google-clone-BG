...
Define the referrer policy standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The referrer policy requirement is explicit and observable.
...
Keep implementation work focused on one referrer policy outcome and avoid copying third-party branding or behavior without review.