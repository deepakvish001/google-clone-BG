...
Define the performance budget standard for SearchCanvas so the lightweight search interface remains accessible, privacy-conscious, and predictable across browsers.
...
- The performance budget requirement is explicit and observable.
...
Keep implementation work focused on one performance budget outcome and avoid copying third-party branding or behavior without review.